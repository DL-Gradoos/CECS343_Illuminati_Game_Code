 ...
 * @author kevin
 */
public class MovableMouseOverArea extends AbstractComponent {
	/** The default state */
	...
	/** X and Y Coordinates for rendering image*/
	 ...
	 */
	public MovableMouseOverArea(GUIContext container, Image image, int x, int y, ComponentListener listener) {
	 ...
	 *            the position of the area
	 */
	public MovableMouseOverArea(GUIContext container, Image image, int x, int y) {
		this(container, image, x, y, image.getWidth(), image.getHeight());
	}
	 ...
	 */
	public MovableMouseOverArea(GUIContext container, Image image, Shape shape) {
		super(container);
	...
	public void render(GUIContext container, Graphics g) {
		if (currentImage != null) {
			...
			float xp = xCoords + ((getWidth() - currentImage.getWidth()) / 2.0f);
			float yp = yCoords + ((getHeight() - currentImage.getHeight()) / 2.0f);
	...
	/**
	 * DON'T USE THIS METHOD, EVERYTHING WILL BECOME WONKY
	...
	/**
	 * Moves the image, but leaves the mouse over area in the same position
	 * 
